...
INTERFACE
  ...
  PROCEDURE al_color_hsl_to_rgb (h, s, l: AL_FLOAT; VAR r, g, b: AL_FLOAT); CDECL;
    EXTERNAL ALLEGRO_COLOR_LIB_NAME;
  FUNCTION al_color_name_to_rgb (CONST name: STRING; VAR r, g, b: AL_FLOAT): AL_BOOL; {$IFDEF HAS_INLINE}INLINE;{$ENDIF}
  FUNCTION al_color_rgb_to_name (r, g, b: AL_FLOAT): STRING; {$IFDEF HAS_INLINE}INLINE;{$ENDIF}
  ...
  PROCEDURE al_color_rgb_to_yuv (r, g, b: AL_FLOAT; VAR y, u, v: AL_FLOAT); CDECL;
    EXTERNAL ALLEGRO_COLOR_LIB_NAME;
  PROCEDURE al_color_rgb_to_html (r, g, b: AL_FLOAT; VAR str: STRING); {$IFDEF HAS_INLINE}INLINE;{$ENDIF}
  PROCEDURE al_color_html_to_rgb (CONST str: STRING; VAR r, g, b: AL_FLOAT); {$IFDEF HAS_INLINE}INLINE;{$ENDIF}
  ...
  FUNCTION al_color_hsv (h, s, v: AL_FLOAT): ALLEGRO_COLOR; CDECL;
    EXTERNAL ALLEGRO_COLOR_LIB_NAME;
  FUNCTION al_color_name (CONST name: STRING): ALLEGRO_COLOR; {$IFDEF HAS_INLINE}INLINE;{$ENDIF}
  FUNCTION al_color_html (CONST str: STRING): ALLEGRO_COLOR; {$IFDEF HAS_INLINE}INLINE;{$ENDIF}

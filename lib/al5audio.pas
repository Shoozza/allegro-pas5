...
INTERFACE
   ...
   *)
    ALLEGRO_AUDIO_DEPTH = (
      ALLEGRO_AUDIO_DEPTH_INT8     {$IFDEF FPC}:{$ENDIF}= $00,
      ALLEGRO_AUDIO_DEPTH_INT16    {$IFDEF FPC}:{$ENDIF}= $01,
      ALLEGRO_AUDIO_DEPTH_INT24    {$IFDEF FPC}:{$ENDIF}= $02,
      ALLEGRO_AUDIO_DEPTH_FLOAT32  {$IFDEF FPC}:{$ENDIF}= $03,

      ALLEGRO_AUDIO_DEPTH_UNSIGNED {$IFDEF FPC}:{$ENDIF}= $08,

    (* For convenience *)
      ALLEGRO_AUDIO_DEPTH_UINT16 {$IFDEF FPC}:{$ENDIF}= $09, {<ALLEGRO_AUDIO_DEPTH_INT16 OR ALLEGRO_AUDIO_DEPTH_UNSIGNED, }
      ALLEGRO_AUDIO_DEPTH_UINT24 {$IFDEF FPC}:{$ENDIF}= $0A  {<ALLEGRO_AUDIO_DEPTH_INT24 OR ALLEGRO_AUDIO_DEPTH_UNSIGNED  }
    );
   ...
   *)
    ALLEGRO_CHANNEL_CONF = (
      ALLEGRO_CHANNEL_CONF_1   {$IFDEF FPC}:{$ENDIF}= $10,
      ALLEGRO_CHANNEL_CONF_2   {$IFDEF FPC}:{$ENDIF}= $20,
      ALLEGRO_CHANNEL_CONF_3   {$IFDEF FPC}:{$ENDIF}= $30,
      ALLEGRO_CHANNEL_CONF_4   {$IFDEF FPC}:{$ENDIF}= $40,
      ALLEGRO_CHANNEL_CONF_5_1 {$IFDEF FPC}:{$ENDIF}= $51,
      ALLEGRO_CHANNEL_CONF_6_1 {$IFDEF FPC}:{$ENDIF}= $61,
      ALLEGRO_CHANNEL_CONF_7_1 {$IFDEF FPC}:{$ENDIF}= $71
    );



    ALLEGRO_PLAYMODE = (
      ALLEGRO_PLAYMODE_ONCE   {$IFDEF FPC}:{$ENDIF}= $100,
      ALLEGRO_PLAYMODE_LOOP   {$IFDEF FPC}:{$ENDIF}= $101,
      ALLEGRO_PLAYMODE_BIDIR  {$IFDEF FPC}:{$ENDIF}= $102
    {
    ...
    ALLEGRO_MIXER_QUALITY = (
      ALLEGRO_MIXER_QUALITY_POINT   {$IFDEF FPC}:{$ENDIF}= $110,
      ALLEGRO_MIXER_QUALITY_LINEAR  {$IFDEF FPC}:{$ENDIF}= $111
    );

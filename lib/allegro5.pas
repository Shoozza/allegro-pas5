...
program start.)
   ...
   *)
    ...
    { @exclude }
      ALLEGRO_PIXEL_FORMAT_ANY {$IFDEF FPC}:{$ENDIF}= 0,
    { @exclude }
  ...
  (* Blending modes.  Documented at al_set_blender. *)
    ALLEGRO_BLEND_MODE = (
    { @exclude }
      ALLEGRO_ZERO {$IFDEF FPC}:{$ENDIF}= 0,
    { @exclude }
      ALLEGRO_ONE {$IFDEF FPC}:{$ENDIF}= 1,
    { @exclude }
      ALLEGRO_ALPHA {$IFDEF FPC}:{$ENDIF}= 2,
    { @exclude }
      ALLEGRO_INVERSE_ALPHA {$IFDEF FPC}:{$ENDIF}= 3
    );
  ...
  (* Blending modes.  Documented at al_set_blender. *)
    ...
    { @exclude }
      ALLEGRO_ADD {$IFDEF FPC}:{$ENDIF}= 0,
    { @exclude }
      ALLEGRO_SRC_MINUS_DEST {$IFDEF FPC}:{$ENDIF}= 1,
    { @exclude }
      ALLEGRO_DEST_MINUS_SRC {$IFDEF FPC}:{$ENDIF}= 2,
    { @exclude }
...
(* internal values *)
  ...
  TYPE
    ...
    ALLEGRO_JOYFLAGS = (
      ALLEGRO_JOYFLAG_DIGITAL  {$IFDEF FPC}:{$ENDIF}= $01,
      ALLEGRO_JOYFLAG_ANALOGUE {$IFDEF FPC}:{$ENDIF}= $02
    );
 ...
 ***********)
  ...
  (* Mouse cursors *)
    ...
    ALLEGRO_SYSTEM_MOUSE_CURSOR = (
      ALLEGRO_SYSTEM_MOUSE_CURSOR_NONE        {$IFDEF FPC}:{$ENDIF}=  0,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_DEFAULT     {$IFDEF FPC}:{$ENDIF}=  1,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_ARROW       {$IFDEF FPC}:{$ENDIF}=  2,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_BUSY        {$IFDEF FPC}:{$ENDIF}=  3,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_QUESTION    {$IFDEF FPC}:{$ENDIF}=  4,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_EDIT        {$IFDEF FPC}:{$ENDIF}=  5,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_MOVE        {$IFDEF FPC}:{$ENDIF}=  6,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_RESIZE_N    {$IFDEF FPC}:{$ENDIF}=  7,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_RESIZE_W    {$IFDEF FPC}:{$ENDIF}=  8,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_RESIZE_S    {$IFDEF FPC}:{$ENDIF}=  9,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_RESIZE_E    {$IFDEF FPC}:{$ENDIF}= 10,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_RESIZE_NW   {$IFDEF FPC}:{$ENDIF}= 11,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_RESIZE_SW   {$IFDEF FPC}:{$ENDIF}= 12,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_RESIZE_SE   {$IFDEF FPC}:{$ENDIF}= 13,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_RESIZE_NE   {$IFDEF FPC}:{$ENDIF}= 14,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_PROGRESS    {$IFDEF FPC}:{$ENDIF}= 15,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_PRECISION   {$IFDEF FPC}:{$ENDIF}= 16,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_LINK        {$IFDEF FPC}:{$ENDIF}= 17,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_ALT_SELECT  {$IFDEF FPC}:{$ENDIF}= 18,
      ALLEGRO_SYSTEM_MOUSE_CURSOR_UNAVAILABLE {$IFDEF FPC}:{$ENDIF}= 19,
 ...
 *********)
  ...
  TYPE
    ALLEGRO_STATE_FLAGS = (
      ALLEGRO_STATE_NEW_DISPLAY_PARAMETERS {$IFDEF FPC}:{$ENDIF}= $0001,
      ALLEGRO_STATE_NEW_BITMAP_PARAMETERS  {$IFDEF FPC}:{$ENDIF}= $0002,
      ALLEGRO_STATE_DISPLAY                {$IFDEF FPC}:{$ENDIF}= $0004,
      ALLEGRO_STATE_TARGET_BITMAP          {$IFDEF FPC}:{$ENDIF}= $0008,
      ALLEGRO_STATE_BITMAP                 {$IFDEF FPC}:{$ENDIF}= $000A, {<ALLEGRO_STATE_TARGET_BITMAP + ALLEGRO_STATE_NEW_BITMAP_PARAMETERS, }
      ALLEGRO_STATE_BLENDER                {$IFDEF FPC}:{$ENDIF}= $0010,
      ALLEGRO_STATE_NEW_FILE_INTERFACE     {$IFDEF FPC}:{$ENDIF}= $0020,
      ALLEGRO_STATE_TRANSFORM              {$IFDEF FPC}:{$ENDIF}= $0040,

      ALLEGRO_STATE_ALL                    {$IFDEF FPC}:{$ENDIF}= $FFFF
    );

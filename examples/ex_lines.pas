...
(* XXX the software line drawer currently doesn't perform clipping properly *)
  ...
  CONST
   ...
   PROCEDURE RedDot (x, y: INTEGER); {$IFDEF HAS_INLINE}INLINE;{$ENDIF}
   BEGIN
   ...
   PROCEDURE DrawClipRect; {$IFDEF HAS_INLINE}INLINE;{$ENDIF}
   BEGIN
   ...
   PROCEDURE SetClipRect; {$IFDEF HAS_INLINE}INLINE;{$ENDIF}
   BEGIN
   ...
   PROCEDURE ResetClipRect; {$IFDEF HAS_INLINE}INLINE;{$ENDIF}
   BEGIN
